"use strict";var _createClass=(function(){function defineProperties(target,props){for(var i=0;i < props.length;i++) {var descriptor=props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if("value" in descriptor)descriptor.writable = true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};})();var _slicedToArray=(function(){function sliceIterator(arr,i){var _arr=[];var _n=true;var _d=false;var _e=undefined;try{for(var _i=arr[Symbol.iterator](),_s;!(_n = (_s = _i.next()).done);_n = true) {_arr.push(_s.value);if(i && _arr.length === i)break;}}catch(err) {_d = true;_e = err;}finally {try{if(!_n && _i["return"])_i["return"]();}finally {if(_d)throw _e;}}return _arr;}return function(arr,i){if(Array.isArray(arr)){return arr;}else if(Symbol.iterator in Object(arr)){return sliceIterator(arr,i);}else {throw new TypeError("Invalid attempt to destructure non-iterable instance");}};})();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}var MarsObject=(function(){var _=require("./underscore-extended.js");var UIDGenerator=require("./UIDGenerator");var CALLBACK_UID_KEY="_mars_graph_callback_uid";var CHANGE_UID_PREFIX="mars_graph_change_uid_";var uidGenerator=new UIDGenerator({sequenceLength:30}); /*
     ...
     */function callbackify(callback){if(_.isFunction(callback)){if(!callback[CALLBACK_UID_KEY]){callback[CALLBACK_UID_KEY] = uidGenerator.generate();}}else if(_.isArray(callback)){callback.map(function(fn){if(!fn[CALLBACK_UID_KEY]){fn[CALLBACK_UID_KEY] = uidGenerator.generate();}});}return callback;} /*
     Gets the keys for the different check (set, get, verify) events for a
     specific path.
     */function getCheckKeys(self,path){var setKey="" + CHANGE_UID_PREFIX + path + "_set";var getKey="" + CHANGE_UID_PREFIX + path + "_get";var verifyKey="" + CHANGE_UID_PREFIX + path + "_verify";var init=false;if(self._checks[verifyKey] === undefined){init = true;self._checks[verifyKey] = [];}if(self._checks[getKey] === undefined){init = true;self._checks[getKey] = [];}if(self._checks[setKey] === undefined){init = true;self._checks[setKey] = [];}return [getKey,setKey,verifyKey,init];} /*
     ...
     */function attachAccessors(self,path,_ref){var _ref2=_slicedToArray(_ref,3);var getKey=_ref2[0];var setKey=_ref2[1];var verifyKey=_ref2[2];var _$getPathData=_.getPathData(self._data,path);var ref=_$getPathData.ref;var key=_$getPathData.key;if(ref === undefined){return self;}var val=ref[key];Object.defineProperty(ref,key,{set:function set(nVal){if(self._checks[verifyKey] !== undefined){var _iteratorNormalCompletion=true;var _didIteratorError=false;var _iteratorError=undefined;try{for(var _iterator=self._checks[verifyKey][Symbol.iterator](),_step;!(_iteratorNormalCompletion = (_step = _iterator.next()).done);_iteratorNormalCompletion = true) {var check=_step.value;if(!check(nVal)){return;}}}catch(err) {_didIteratorError = true;_iteratorError = err;}finally {try{if(!_iteratorNormalCompletion && _iterator.return){_iterator.return();}}finally {if(_didIteratorError){throw _iteratorError;}}}}if(self._checks[setKey] !== undefined){var _iteratorNormalCompletion2=true;var _didIteratorError2=false;var _iteratorError2=undefined;try{for(var _iterator2=self._checks[setKey][Symbol.iterator](),_step2;!(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);_iteratorNormalCompletion2 = true) {var processor=_step2.value;var possible=processor(nVal);if(possible !== undefined){nVal = possible;}}}catch(err) {_didIteratorError2 = true;_iteratorError2 = err;}finally {try{if(!_iteratorNormalCompletion2 && _iterator2.return){_iterator2.return();}}finally {if(_didIteratorError2){throw _iteratorError2;}}}}val = nVal;},get:function get(){var retVal=val;if(self._checks[getKey] !== undefined){var _iteratorNormalCompletion3=true;var _didIteratorError3=false;var _iteratorError3=undefined;try{for(var _iterator3=self._checks[getKey][Symbol.iterator](),_step3;!(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done);_iteratorNormalCompletion3 = true) {var fetcher=_step3.value;retVal = fetcher(val);}}catch(err) {_didIteratorError3 = true;_iteratorError3 = err;}finally {try{if(!_iteratorNormalCompletion3 && _iterator3.return){_iterator3.return();}}finally {if(_didIteratorError3){throw _iteratorError3;}}}}return retVal;}});} /*
     ...
     and cluttering things up */var _proto={ /*
         ...
         */onJSON:function onJSON(json){if(!_.isObject(json)){return this;}for(var evt in json) {if(json.hasOwnProperty(evt)){_proto.onEvtCallback.call(this,evt,json[evt]);}}return this;}, /*
         ...
         event.
         */onEvtCallback:function onEvtCallback(evt,callbacks){if(!_.isString(evt) || _.isUndefined(callbacks)){return this;}if(!_.isArray(callbacks)){callbacks = [callbacks];}callbacks = callbacks.filter(function(val){return _.isFunction(val);}).map(callbackify);if(!callbacks.length){return this;}if(!_.isArray(this._listeners[evt])){this._listeners[evt] = [];}this._listeners[evt] = this._listeners[evt].concat(callbacks);return this;}, /*
         Used by the `off` method when one argument is supplied.
         Behaves the same way as `onJSON` except it calls
         `offEvtCallback`
         */offJSON:function offJSON(json){if(!_.isObject(json)){return this;}for(var evt in json) {if(json.hasOwnProperty(evt)){_proto.offEvtCallback.call(this,evt,json[evt]);}}return this;}, /*
         ...
         */offEvtCallback:function offEvtCallback(evt){var callbacks=arguments.length <= 1 || arguments[1] === undefined?[]:arguments[1];if(this._listeners[evt] === undefined){return this;}if(!_.isArray(callbacks)){callbacks = [callbacks];}callbacks = callbacks.filter(function(val){return _.isFunction(val) && val[CALLBACK_UID_KEY];}).map(function(val){return val[CALLBACK_UID_KEY];});if(!callbacks.length){return this;}var filtered=this._listeners[evt].filter(function(val){return callbacks.indexOf(val[CALLBACK_UID_KEY]) === -1;});if(!filtered.length){delete this._listeners[evt];}else {this._listeners[evt] = filtered;}return this;}, /*
         ...
         event data.
         */fireJSON:function fireJSON(json){for(var eventName in json) {if(json.hasOwnProperty(eventName)){_proto.fireEvent.call(this,eventName,json[eventName]);}}return this;}, /*
         ...
         */dataKeyValue:function dataKeyValue(path,value){if(!_.isString(path)){return this;}var _$getPathData2=_.getPathData(this._data,path);var ref=_$getPathData2.ref;var key=_$getPathData2.key;if(ref !== undefined){ref[key] = value;}}, /*
         ...
         */processJSON:function processJSON(json){var _this=this;_.walkJSON(json,function(val,path){if(_.isFunction(val) || _.isArray(val)){_proto.processKeyValue.call(_this,path,val);return true;}});}, /*
         ...
         attaches them.
         */processKeyValue:function processKeyValue(path,listeners){if(!_.isString(path)){return this;}if(!_.isArray(listeners)){listeners = [listeners];}listeners = listeners.filter(function(val){return _.isFunction(val);});var _getCheckKeys=getCheckKeys(this,path);var _getCheckKeys2=_slicedToArray(_getCheckKeys,4);var getKey=_getCheckKeys2[0];var setKey=_getCheckKeys2[1];var verifyKey=_getCheckKeys2[2];var init=_getCheckKeys2[3];this._checks[setKey] = this._checks[setKey].concat(listeners);if(init){attachAccessors(this,path,[getKey,setKey,verifyKey]);}}, /*
         Called by the `fetch` method when one argument is supplied.
         Takes in a JSON object representing the structure of the data object
         with values representing fetchers and calls `fetchKeyValue` for
         them. Works recursively.
         */fetchJSON:function fetchJSON(json){var _this2=this;var path=arguments.length <= 1 || arguments[1] === undefined?"":arguments[1];_.walkJSON(json,function(val,path){if(_.isFunction(val) || _.isArray(val)){_proto.fetchKeyValue.call(_this2,path,val);return true;}});}, /*
         ...
         attaches them.
         */fetchKeyValue:function fetchKeyValue(path,fetchers){if(!_.isString(path)){return this;}if(!_.isArray(fetchers)){fetchers = [fetchers];}fetchers = fetchers.filter(function(val){return _.isFunction(val);});var _getCheckKeys3=getCheckKeys(this,path);var _getCheckKeys4=_slicedToArray(_getCheckKeys3,4);var getKey=_getCheckKeys4[0];var setKey=_getCheckKeys4[1];var verifyKey=_getCheckKeys4[2];var init=_getCheckKeys4[3];this._checks[getKey] = this._checks[setKey].concat(fetchers);if(init){attachAccessors(this,path,[getKey,setKey,verifyKey]);}}, /*
         Called by the `check` method when one argument is supplied.
         Takes in a JSON object representing the structure of the data object
         with values representing fetchers and calls `checkKeyValue` for
         them. Works recursively.
         */checkJSON:function checkJSON(json){var _this3=this;var path=arguments.length <= 1 || arguments[1] === undefined?"":arguments[1];_.walkJSON(json,function(val,path){if(_.isFunction(val) || _.isArray(val)){_proto.checkKey.call(_this3,path,val);return true;}});}, /*
         ...
         attaches them.
         */checkKey:function checkKey(path,checks){if(!_.isString(path) || _.isUndefined(checks)){return this;}if(!_.isArray(checks)){checks = [checks];}checks = checks.filter(function(val){return _.isFunction(val);});var _getCheckKeys5=getCheckKeys(this,path);var _getCheckKeys6=_slicedToArray(_getCheckKeys5,4);var getKey=_getCheckKeys6[0];var setKey=_getCheckKeys6[1];var verifyKey=_getCheckKeys6[2];var init=_getCheckKeys6[3];this._checks[verifyKey] = this._checks[verifyKey].concat(checks);if(init){attachAccessors(this,path,[getKey,setKey,verifyKey]);}return this;}};var MarsObject=(function(){function MarsObject(){var cfg=arguments.length <= 0 || arguments[0] === undefined?{}:arguments[0];_classCallCheck(this,MarsObject);var _cfg$data=cfg.data;var data=_cfg$data === undefined?{}:_cfg$data;var _cfg$listen=cfg.listen;var listen=_cfg$listen === undefined?{}:_cfg$listen;var _cfg$checks=cfg.checks;var checks=_cfg$checks === undefined?{}:_cfg$checks;var _cfg$change=cfg.change;var change=_cfg$change === undefined?{}:_cfg$change;this._listeners = {};this._data = {};this._checks = {};for(var evt in listen) {if(listen.hasOwnProperty(evt)){this.on(evt,listen[evt]);}}this.data(data);this.check(checks);this.process(change);} /*
         Description:
         ...
         Usage:
            ...
            on(json)
                ...
                them
         */_createClass(MarsObject,[{key:"on",value:function on(){if(arguments.length === 1){return _proto.onJSON.apply(this,arguments);}if(arguments.length >= 2){return _proto.onEvtCallback.apply(this,arguments);}return this;} /*
         Description:
         ...
         */},{key:"check",value:function check(){if(arguments.length === 1){_proto.checkJSON.apply(this,arguments);}else if(arguments.length === 2){_proto.checkKey.apply(this,arguments);}return this;}}]);return MarsObject;})();module.exports = MarsObject;return MarsObject;})();